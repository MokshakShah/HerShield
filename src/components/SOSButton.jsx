...
function SOSButton() {
    ...
    const sendAudioToBackend = async (audioBlob) => {
        ...
        try {
            ...
            const axiosResponse = await axios.post('process.env.SENSITIVE_VALUE_1', formData, {
                headers: {
    ...
    const handleSendTextMessage = async () => {
        try {
            ...
            const axiosResponse = await axios.post('process.env.SENSITIVE_VALUE_2', { text: messageText });
